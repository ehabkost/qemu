...
#define DEFINE_PROP_MULTIFD_COMPRESSION(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_multifd_compression, \
                     MultiFDCompression)
#define DEFINE_PROP_LOSTTICKPOLICY(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_losttickpolicy, \
                     LostTickPolicy)
#define DEFINE_PROP_BLOCKDEV_ON_ERROR(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_blockdev_on_error, \
                     BlockdevOnError)
#define DEFINE_PROP_BIOS_CHS_TRANS(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_bios_chs_trans, int)
#define DEFINE_PROP_BLOCKSIZE(_n, _s, _f) \
    DEFINE_PROP_UNSIGNED(_n, _s, _f, 0, qdev_prop_blocksize, uint32_t)
#define DEFINE_PROP_PCI_HOST_DEVADDR(_n, _s, _f) \
    DEFINE_PROP(_n, _s, _f, qdev_prop_pci_host_devaddr, PCIHostDeviceAddress)
#define DEFINE_PROP_OFF_AUTO_PCIBAR(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_off_auto_pcibar, \
                     OffAutoPCIBAR)
#define DEFINE_PROP_PCIE_LINK_SPEED(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_pcie_link_speed, \
                     PCIExpLinkSpeed)
#define DEFINE_PROP_PCIE_LINK_WIDTH(_n, _s, _f, _d) \
    DEFINE_PROP_ENUM(_n, _s, _f, _d, qdev_prop_pcie_link_width, \
                     PCIExpLinkWidth)
...
#define DEFINE_PROP_FDC_DRIVE_TYPE(_name, _state, _field, _defval) \
    DEFINE_PROP_ENUM(_name, _state, _field, _defval,               \
