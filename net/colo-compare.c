...
static Property colo_compare_props[] = {
    DEFINE_PROP_STRING("primary_in", CompareState, pri_indev),
    DEFINE_PROP_STRING("secondary_in", CompareState, sec_indev),
    DEFINE_PROP_STRING("outdev", CompareState, outdev),
    /* This parameter just for Xen COLO */
    DEFINE_PROP_STRING("notify_dev", CompareState, notify_dev),
    DEFINE_PROP_LINK("iothread", CompareState, iothread, TYPE_IOTHREAD, IOThread *),
    DEFINE_PROP_BOOL("vnet_hdr_support", CompareState, vnet_hdr, false),
...
static void colo_compare_class_init(ObjectClass *oc, void *data)
{
    ...
    object_class_add_static_props(oc, colo_compare_props, NULL);
